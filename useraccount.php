...
<?php
	...
	if(isset($_GET['id'])){
	  $post_id = $_GET['id'];
	  $delete = $user->delete_post($post_id);
	}

	if(isset($_GET['cid'])){
	  $post_id = $_GET['cid'];
	  $complete = $user->complete_job($post_id);
	}
	$allPost = $user->get_userPosts();
	//var_dump($_SESSION);
				...
				<div class="container">
						...
						foreach ($allPost as $all_posts) {
							...
							echo "<div class='card'>";
								...
								echo "<div class='card-body'>";
									...
									echo "</p>";
									echo "<a href='useraccount.php?id=";
									echo $all_posts['id'];
									echo "' class='btn btn-danger'>Delete</a>";
									echo "<a href='useraccount.php?cid=";
									echo $all_posts['id'];
									echo "' class='btn btn-primary'>Mark as complete</a>";
								echo "</div>";
							echo "</div>";
							echo "<br>";
						}
					...
					<div class="col-md-4">
			          ...
			          <div class="card my-4">
			            <div class="card-body">
			              <div class="input-group">
			              	<a href="completed.php" class="btn btn-primary btn-lg btn-block">View completed jobs!</a>
			              </div>
			            </div>
			          </div>
			          	<div class="card my-4">
